...
export const textSecondary = "text-[rgba(23,32,51,0.7)] dark:text-[rgba(242,246,255,0.76)]";

export const textTertiary = "text-[rgba(23,32,51,0.5)] dark:text-[rgba(242,246,255,0.52)]";

export const subtleBorder = "border-[rgba(110,128,160,0.18)] dark:border-[rgba(176,202,255,0.16)]";

export const strongBorder = "border-[rgba(97,119,155,0.28)] dark:border-[rgba(190,214,255,0.28)]";
